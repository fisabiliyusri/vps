...
$Nginx_Port= "88";	// Nginx Port
$site_name        = "ono rumongo biso ning biso'o rumongso🙏";
$site_description = "Solo The Spirit Of Java";
$site_template    = "cyborg"; // (flatly, darkly, sketchy, lumen, cyborg, materia)
$site_ovpnmonitoring = "http://$${MYIP}:89"; // Openvpn Monitoring
$site_v2ray = "http://${MYIP}:54321"; // v2ray ip and PORT
$site_config = "http://${MYIP}:88/index.html"; // list of config
$config_zips = "http://${MYIP}:88/config.zip"; // ovpn zip check it on /home/vps/public_html
...
$port_dropbear= '389 | 390';  	 // Dropbear Ports
$port_ssl_dp= '442';                    	 // SSL through Dropbear
$port_ssl_ssh= '445';                    	 // SSL through OpenSSH
$port_ssl_ovpn= '990 | 3269';                    	 // SSL through Openvpn
$port_squid= '8000 | 8080 | 9005';  // Squid Ports
$port_privoxy= '3000 | 3100'; 	 // Privoxy Ports
